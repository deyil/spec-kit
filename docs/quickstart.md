...
```bash
uvx --from git+https://github.com/deyil/spec-kit specify init <PROJECT_NAME> --script ps  # Force PowerShell
uvx --from git+https://github.com/deyil/spec-kit specify init <PROJECT_NAME> --script sh  # Force POSIX shell
```
